    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='font-semibold text-lg text-gray-600'>Carrières chez ConsultDoc</p>
          <p className='text-gray-500'>En savoir plus sur nos équipes et nos offres d'emploi.</p>
          <button className='border border-black px-8 py-4 text-sm hover:bg-black hover:text-white transition-all duration-500'>Explorer les offres d'emploi</button>
        </div>
